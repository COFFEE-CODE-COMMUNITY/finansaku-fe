  ...
  return(
    <div className='flex justify-center relative items-center '>
        <div className='flex flex-col absolute top-24 items-center justify-center'>
            ...
            <p className='text-center text-lg text-white'>Lihat gambaran keuanganmu di sini. Mulai dari alokasi tiap kategori hingga notes dalam kalender. <br/>terlebih dahulu <span className='text-blue-600'>
